...
func NewServer(opts *genericoptions.RecommendedOptions) (*server.GenericAPIServer, error) {
	...
	// Real OpenAPI configs using generated definitions
	genericCfg.OpenAPIConfig = server.DefaultOpenAPIConfig(netguardv1beta1.GetOpenAPIDefinitions, openapi.NewDefinitionNamer(scheme.Scheme))
	genericCfg.OpenAPIConfig.Info.Title = "Netguard"
	genericCfg.OpenAPIConfig.Info.Version = "v1beta1"

	genericCfg.OpenAPIV3Config = server.DefaultOpenAPIV3Config(netguardv1beta1.GetOpenAPIDefinitions, openapi.NewDefinitionNamer(scheme.Scheme))
