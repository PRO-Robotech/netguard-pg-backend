...
func schema_k8s_apis_netguard_v1beta1_AddressGroupReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "AddressGroupReference represents a reference to an AddressGroup with additional metadata",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ref": {
						SchemaProps: spec.SchemaProps{
							Description: "Reference to the AddressGroup object",
							Default:     map[string]interface{}{},
							Ref:         ref("netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.NamespacedObjectReference"),
						},
					},
					"source": {
						SchemaProps: spec.SchemaProps{
							Description: "Source indicates how this address group was registered (spec or binding)",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"xAggregatedAddressGroups": {
						SchemaProps: spec.SchemaProps{
							Description: "XAggregatedAddressGroups contains all AddressGroup references from both spec and bindings",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"addressGroups": {
						SchemaProps: spec.SchemaProps{
							Description: "AddressGroups defines address groups directly referenced in the service spec",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
