...
func schema_k8s_apis_netguard_v1beta1_AddressGroupBindingSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.NamespacedObjectReference", "netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.ObjectReference"},
	}
}
...
func schema_k8s_apis_netguard_v1beta1_IEAgAgRuleSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.ObjectReference", "netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.PortSpec"},
	}
}
...
func schema_k8s_apis_netguard_v1beta1_Service(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.ServiceSpec", "netguard-pg-backend/internal/k8s/apis/netguard/v1beta1.ServiceStatus"},
	}
}
