...
func (r *REST) List(ctx context.Context, options *metainternalversion.ListOptions) (runtime.Object, error) {
	...
	err = utils.ApplySorting(bindingPtrs, sortBy,
		// idFn для извлечения ResourceIdentifier
		func(nb *models.NetworkBinding) models.ResourceIdentifier {
		...
		func(nb *models.NetworkBinding) runtime.Object {
			k8sObj, _ := r.converter.FromDomain(ctx, nb)
			return k8sObj
		},
	)
	if err != nil {
		return nil, fmt.Errorf("failed to sort network bindings: %w", err)
	}
