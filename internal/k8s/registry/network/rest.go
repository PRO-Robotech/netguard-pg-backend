...
func (r *REST) List(ctx context.Context, options *metainternalversion.ListOptions) (runtime.Object, error) {
	...
	err = utils.ApplySorting(networkPtrs, sortBy,
		// idFn для извлечения ResourceIdentifier
		func(n *models.Network) models.ResourceIdentifier {
		...
		func(n *models.Network) runtime.Object {
			k8sObj, _ := r.converter.FromDomain(ctx, n)
			return k8sObj
		},
	)
	if err != nil {
		return nil, fmt.Errorf("failed to sort networks: %w", err)
	}
