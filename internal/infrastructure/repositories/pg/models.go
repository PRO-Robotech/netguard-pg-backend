...
type (
	...
	IEAgAgRule struct {
		Name                       string            `db:"name"`
		Namespace                  string            `db:"namespace"`
		Transport                  TransportProtocol `db:"transport"`
		Traffic                    Traffic           `db:"traffic"`
		AddressGroupLocalName      string            `db:"address_group_local_name"`
		AddressGroupLocalNamespace string            `db:"address_group_local_namespace"`
		AddressGroupName           string            `db:"address_group_name"`
		AddressGroupNamespace      string            `db:"address_group_namespace"`
		Ports                      string            `db:"ports"`
