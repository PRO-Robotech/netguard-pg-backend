...
type (
	...
	// ConditionOnlyOperation indicates this sync operation is for condition updates only
	// This allows PostgreSQL backend to only update conditions in k8s_metadata, not the main resource table
