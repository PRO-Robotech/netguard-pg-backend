...
type ServiceLister interface {
	...
	List(selector labels.Selector) (ret []*netguardv1beta1.Service, err error)
...
type serviceLister struct {
	listers.ResourceIndexer[*netguardv1beta1.Service]
}

// NewServiceLister returns a new ServiceLister.
func NewServiceLister(indexer cache.Indexer) ServiceLister {
	return &serviceLister{listers.New[*netguardv1beta1.Service](indexer, netguardv1beta1.Resource("service"))}
}

// Services returns an object that can list and get Services.
func (s *serviceLister) Services(namespace string) ServiceNamespaceLister {
	return serviceNamespaceLister{listers.NewNamespaced[*netguardv1beta1.Service](s.ResourceIndexer, namespace)}
}
...
type ServiceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*netguardv1beta1.Service, error)
