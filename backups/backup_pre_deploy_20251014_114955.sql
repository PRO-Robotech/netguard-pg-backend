...
incloud-sgroups	to-nft-agent-42sgv	d09112e9-8031-4906-9219-31196d4c6b14	\N	\N	f	\N	\N	\N	\N	9	[{"ip": "fe80::fc43:42ff:fe1f:a4ea"}, {"ip": "127.0.0.1"}, {"ip": "10.244.0.49"}, {"ip": "::1"}]
\.
...
SELECT pg_catalog.setval('public.k8s_metadata_resource_version_seq', 9, true);
...
SELECT pg_catalog.setval('public.netguard_db_ver_id_seq', 25, true);
